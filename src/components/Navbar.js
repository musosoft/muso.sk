...
const Navbar = class extends React.Component {
            ...
            <nav className="hidden md:flex space-x-10">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <svg
                    className={`ml-2 h-5 w-5 ${this.state.navBarActiveClass} group-hover:text-gray-500`}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
  ...
  --> */}
        <div
          className={`${this.state.navBarActiveClass} absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden`}
        >

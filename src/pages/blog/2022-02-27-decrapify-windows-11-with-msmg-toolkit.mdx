...
description: How to improve performance, remove bloatware from Windows 11 installer and make your own setup iso.
featuredpost: false
...
tags:
  ...
  - tweak
---
Setting up the operating system without any extra crap might be hard nowadays. Thanks to MSMG Toolkit you can remove all bloatware and unused components from Windows 11 Setup ISO file. This is very helpful for those who care about Performance and Privacy and is recommended for Low end PCs.
...
3. Go back and choose "Select Source from \<DVD> Folder" - agree "y" all and pick an edition you have a license for
